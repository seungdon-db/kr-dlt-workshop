...
# ANSWER
# Programatically create pipeline just in case it doesn't exist.
DA.create_pipeline(pipeline_language, from_job=True)
...
# or cannot work through the exercise of creating the job.
DA.create_job(pipeline_language)

# This function is provided to run the job and block 
# until it has terminated, failed or skipped.
DA.start_job()
