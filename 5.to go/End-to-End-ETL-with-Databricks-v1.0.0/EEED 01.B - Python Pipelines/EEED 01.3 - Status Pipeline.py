...
# MAGIC 
# MAGIC <img src="https://files.training.databricks.com/images/icon_hint_24.png"> The link to this notebook can be found back in [EEED 01 - DLT UI Walkthrough]($../EEED 01 - DLT UI Walkthrough)<br/>
